const strings: Record<string, string> = {
  ...
  'live.endSessionConfirmTitle': 'Really end session?',
  'live.endSessionConfirmDesc': '{count} listeners are currently connected. Ending the session will disconnect everyone.',
  'live.slideToEnd': 'Slide to end session',
  'live.cancel': 'Cancel',
  ...
  'settings.whisperDesc': 'Whisper enables speech recognition without internet (~150 MB). Works in all browsers.',
  'settings.whisperReady': 'Whisper model ready',
  'settings.whisperDownload': 'Download Whisper (~150 MB)',
  ...
  'info.feature6Desc': 'Web Speech API for Chrome/Edge, Whisper model (~150 MB) for fully offline STT.',
