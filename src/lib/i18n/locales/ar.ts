const strings: Record<string, string> = {
  ...
  'live.endSessionConfirmTitle': '\u0647\u0644 \u062a\u0631\u064a\u062f \u0625\u0646\u0647\u0627\u0621 \u0627\u0644\u062c\u0644\u0633\u0629 \u0641\u0639\u0644\u0627\u064b\u061f',
  'live.endSessionConfirmDesc': '{count} \u0645\u0633\u062a\u0645\u0639\u064a\u0646 \u0645\u062a\u0635\u0644\u064a\u0646 \u062d\u0627\u0644\u064a\u0627\u064b. \u0625\u0646\u0647\u0627\u0621 \u0627\u0644\u062c\u0644\u0633\u0629 \u0633\u064a\u0642\u0637\u0639 \u062c\u0645\u064a\u0639 \u0627\u0644\u0627\u062a\u0635\u0627\u0644\u0627\u062a.',
  'live.slideToEnd': '\u0627\u0633\u062d\u0628 \u0644\u0644\u0625\u0646\u0647\u0627\u0621',
  'live.cancel': '\u0625\u0644\u063a\u0627\u0621',
  ...
  'live.originalLanguage': 'الأصلي (بدون ترجمة)',
  ...
  'error.sttOffline': 'الإدخال الصوتي يتطلب اتصالاً بالإنترنت. يرجى الاتصال بالإنترنت أو تنزيل نموذج Whisper للاستخدام بدون اتصال.',
  ...
  'favorites.subtitle': 'ترجماتك المحفوظة — وصول سريع إلى العبارات المهمة.',
  'favorites.empty': 'لا توجد مفضلات محفوظة بعد.',
  'favorites.emptyHint': 'اضغط على النجمة عند الترجمة لحفظها هنا.',
  'favorites.search': 'البحث في المفضلة...',
  'favorites.count': 'مفضلات',
  'favorites.clearAll': 'حذف الكل',
  'favorites.remove': 'إزالة من المفضلة',
  'favorites.add': 'حفظ كمفضلة',
  'favorites.noResults': 'لم يتم العثور على مفضلات.',
  'historyPage.title': 'سجل الترجمة',
  'historyPage.subtitle': 'تصفح وبحث وتصفية وتصدير جميع الترجمات السابقة.',
  'historyPage.search': 'البحث في السجل...',
  'historyPage.entries': 'إدخالات',
  'historyPage.export': 'تصدير',
  'history.justNow': 'الآن',
  'history.yesterday': 'أمس',
  'export.title': 'تصدير / استيراد',
  'export.subtitle': 'تصدير واستيراد المفضلات والسجل كملف JSON أو CSV.',
  'export.favorites': 'تصدير المفضلة',
  'export.history': 'تصدير السجل',
  'export.phrasebook': 'تصدير دليل العبارات',
  'export.importData': 'استيراد البيانات',
  'export.importDesc': 'اختر ملف JSON لاستيراد المفضلات أو السجل.',
  'export.importSuccess': 'تم استيراد {count} إدخال.',
  'export.importError': 'فشل الاستيراد. يرجى التحقق من تنسيق الملف.',
  'export.csv': 'CSV',
  'export.json': 'JSON',
  'export.all': 'تصدير الكل',
  'pronunciation.show': 'النطق',
  'pronunciation.hide': 'إخفاء النطق',
  'pronunciation.romanization': 'الكتابة اللاتينية',
  'context.label': 'السياق',
  'context.general': 'عام',
  'context.travel': 'سفر',
  'context.medical': 'طبي',
  'context.legal': 'قانوني',
  'context.business': 'أعمال',
  'context.casual': 'يومي',
  'alternatives.title': 'بدائل',
  'alternatives.show': 'عرض البدائل',
  'alternatives.hide': 'إخفاء البدائل',
  'alternatives.loading': 'جاري تحميل البدائل...',
  'alternatives.none': 'لم يتم العثور على بدائل.',
  'group.title': 'جلسة جماعية',
  'group.subtitle': 'بث متعدد اللغات — متحدث واحد، عدة لغات في آن واحد.',
  'group.participants': 'المشاركون',
  'group.languages': 'اللغات المستهدفة',
  'group.addLanguage': 'إضافة لغة',
}
