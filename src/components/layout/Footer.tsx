        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 mb-6">
          ...
          <div>
            ...
            <ul className="space-y-1 text-xs text-muted-foreground">
              ...
              <li><Link to="/sales/guide" className="hover:text-foreground transition-colors">Stadtfuehrer</Link></li>
              <li><Link to="/sales/agency" className="hover:text-foreground transition-colors">Agenturen</Link></li>
              <li><Link to="/sales/event" className="hover:text-foreground transition-colors">Events</Link></li>
              <li><Link to="/sales/cruise" className="hover:text-foreground transition-colors">Kreuzfahrt</Link></li>
              <li><Link to="/sales/event" className="hover:text-foreground transition-colors">Enterprise</Link></li>
            </ul>
          </div>
          {/* Unternehmen */}
          <div>
