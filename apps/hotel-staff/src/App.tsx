/**
 * Hotel Staff App — Fintutto Hotel Translator
 *
 * Specialized translator for hotel reception, concierge and room service staff.
 * Core differentiator: Bidirectional conversation mode optimized for hotel workflows.
 *
 * Features:
 * - Conversation mode (1:1 bidirectional with guest)
 * - Hotel-specific quick phrases (check-in, check-out, room service, complaints)
 * - Live session as speaker
 * - Text translator for documents
 *
 * Target: hotel-staff.fintutto.world
 */
...
import HotelStaffHomePage from './pages/HotelStaffHomePage'
            ...
            <BrowserRouter>
              ...
              <Routes>
                <Route path="/" element={<Layout />}>
                  <Route index element={<HotelStaffHomePage />} />
