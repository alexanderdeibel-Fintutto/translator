/**
 * NGO Helper App — Refugee Translator (Helfer)
 *
 * Speaker app for social workers, volunteers, and NGO staff.
 * Based on Enterprise app with refugee aid-specific branding and workflow.
 *
 * Features:
 * - Quick session activation (field/office use)
 * - Conversation mode (1:1 counseling sessions)
...
import NgoHelperHomePage from './pages/NgoHelperHomePage'
            ...
            <BrowserRouter>
              ...
              <Routes>
                <Route path="/" element={<Layout />}>
                  {/* Main: Field/office session activation */}
                  <Route index element={<NgoHelperHomePage />} />
