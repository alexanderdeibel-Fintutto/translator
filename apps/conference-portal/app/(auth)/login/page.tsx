    ...
    <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-6 shadow-xl space-y-4">
      ...
      <div>
        ...
        <input
          ...
          className="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:border-slate-500 focus:ring-1 focus:ring-slate-500 outline-none transition"
          required
          autoComplete="email"
        />
      </div>
      ...
      <button
        type="submit"
        disabled={loading}
        className="w-full py-2.5 rounded-lg bg-slate-900 text-white font-medium hover:bg-slate-800 disabled:opacity-50 transition"
      >
        {loading
