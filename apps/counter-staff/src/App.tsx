/**
 * Counter Staff App — Counter Translator (Mitarbeiter)
 *
 * Speaker app for hotel reception, retail counters, trade fair booths, etc.
...
import CounterStaffHomePage from './pages/CounterStaffHomePage'
            ...
            <BrowserRouter>
              ...
              <Routes>
                <Route path="/" element={<Layout />}>
                  <Route index element={<CounterStaffHomePage />} />
