...
const FEATURES = [
  { icon: Languages, title: 'Text-Übersetzer', desc: '45 Sprachen mit 6-Provider-Kaskade und automatischem Fallback. 6 Kontextmodi: Reise, Medizin, Recht, Business, Alltag, Technik.' },
  { icon: Radio, title: 'Live-Sessions', desc: 'Als Speaker oder Zuhörer an Echtzeit-Übersetzungssessions teilnehmen. QR-Code scannen und sofort mitlesen.' },
  { icon: MessageSquare, title: 'Gesprächsmodus', desc: 'Face-to-Face-Übersetzung mit 180-Grad Split-Screen. Ideal beim Arzt, auf der Behörde oder im Hotel.' },
  { icon: Camera, title: 'Kamera-OCR', desc: 'Schilder, Speisekarten und Dokumente fotografieren — die Übersetzung erscheint sofort.' },
  { icon: BookOpen, title: 'Phrasebook', desc: '18 Kategorien mit vorgefertigten Sätzen: Behörde, Arzt, Unterkunft, Notfall und mehr.' },
  ...
  { icon: Volume2, title: 'HD-Sprachausgabe', desc: 'Google Neural2 + Chirp 3 HD. Natürliche Stimmen in 24+ Sprachen.' },
]

const APP_URL = 'https://consumer.fintutto.world'
      ...
      <div className="relative text-center space-y-4 py-12 sm:py-16 overflow-hidden rounded-2xl">
        ...
        <div className="relative z-10 space-y-4">
          ...
          <h1 className="text-3xl sm:text-5xl font-bold leading-tight text-white drop-shadow-lg">
            Übersetze sofort. In 45 Sprachen.
          </h1>
          <p className="text-lg sm:text-xl text-white/80 max-w-2xl mx-auto drop-shadow">
            Der kostenlose Übersetzer mit Spracheingabe, Kamera-OCR, Live-Sessions
            und Offline-Modus. Als PWA direkt im Browser — keine Installation nötig.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center pt-2">
            <a href={APP_URL} target="_blank" rel="noopener noreferrer">
              <Button size="lg" className="gap-2 w-full sm:w-auto bg-sky-600 hover:bg-sky-700">
                Jetzt übersetzen — kostenlos
