/**
 * Conference Speaker App — Conference Translator (Speaker/Organizer)
 *
 * Speaker/organizer app for conferences, events, churches, trade fairs.
 * Core differentiator: Multi-channel system, high-capacity audience, event branding.
 *
 * Features:
 * - Multi-channel support (multiple speakers/rooms)
 * - Large audience live sessions
 * - Event info broadcasting
 * - Speaker dashboard with audience stats
 */
...
import ConferenceSpeakerHomePage from './pages/ConferenceSpeakerHomePage'
            ...
            <BrowserRouter>
              ...
              <Routes>
                <Route path="/" element={<Layout />}>
                  <Route index element={<ConferenceSpeakerHomePage />} />
